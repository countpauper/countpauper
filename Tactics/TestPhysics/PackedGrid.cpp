...
TEST(PackedGrid, Space)
{
    ...
    PackedGrid splitEnv(Engine::Vector(2, 2, 2));
...
TEST(PackedGrid, Fill)
{
    ...
    PackedGrid quadEnv(Engine::Vector(2, 2, 2));
