...
namespace Game
{
    namespace Type
    {
        std::map<const std::wstring_view, Armor::Category> armorCategories(
        {
        ...
        std::map<const std::wstring_view, Element> elementMap(
        {
            { L"None", Element::None },
        ...
        const std::map<const std::wstring_view, Weapon::Style > Weapon::styleMap(
        {
        ...
        std::map<const std::wstring_view, Weapon::Material::Category > weaponMaterialCategories(
        {
