...
namespace Game
{
    ...
    void FluidDynamics::Space(unsigned x, unsigned y, unsigned z)
    {
        voxels = Data(x, y, z);
    }

    void FluidDynamics::World(double radius)
    {
        planetRadius = radius;
    ...
    double FluidDynamics::Elevation(int z) const
    {
    ...
    void FluidDynamics::Air(double temperature, double meters)
    {
    ...
    void FluidDynamics::Wind(const Engine::Vector& speed)
    {
        wind = speed;
        // TODO: set all air flux and boundary
    }

    void FluidDynamics::Sea(int level, double temperature)
    {
    ...
    void FluidDynamics::Hill(const Engine::Line& ridgeLine, double stddev)
    {
    ...
    void FluidDynamics::Wall(const Engine::Line& bottomLine, double height, double thickness)
    {
    ...
    unsigned FluidDynamics::Latitude() const
    {
        return voxels.Latitude();
    }
    unsigned FluidDynamics::Longitude() const
    {
    ...
    Square FluidDynamics::At(const Position& p) const
    {
        auto position = p;
    ...
    */
    ...
    void FluidDynamics::SetDensityToMeshColor()
    {
        if (!mesh)
            return;
        mesh->Invalidate();
        for (auto& vertex : mesh->vertices)
        {
            ...
            auto position = FluidDynamics::Grid(meters);
    ...
    Position FluidDynamics::Grid(const Engine::Coordinate& meters)
    {
        return Position(
    ...
    Engine::Coordinate FluidDynamics::Center(const Position& grid)
    {
    ...
    void FluidDynamics::Render() const
    {
        if (mesh)
        {
    ...
    void FluidDynamics::GenerateMesh()
    {
    ...
    void FluidDynamics::RenderPretty() const
    {
    ...
    void FluidDynamics::RenderAnalysis() const
    {
        assert(glIsEnabled(GL_DEPTH_TEST));
